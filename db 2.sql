...
(73,'Can add hotel payment',19,'add_hotelpayment'),
(74,'Can change hotel payment',19,'change_hotelpayment'),
(75,'Can delete hotel payment',19,'delete_hotelpayment'),
(76,'Can view hotel payment',19,'view_hotelpayment'),
(77,'Can add package payment',20,'add_packagepayment'),
(78,'Can change package payment',20,'change_packagepayment'),
(79,'Can delete package payment',20,'delete_packagepayment'),
(80,'Can view package payment',20,'view_packagepayment'),
(81,'Can add guide payment',21,'add_guidepayment'),
(82,'Can change guide payment',21,'change_guidepayment'),
(83,'Can delete guide payment',21,'delete_guidepayment'),
(84,'Can view guide payment',21,'view_guidepayment');
...
(21,'myapp','guidepayment'),
(7,'myapp','hotel'),
(13,'myapp','hotel_booking'),
(19,'myapp','hotelpayment'),
(8,'myapp','login'),
(9,'myapp','package'),
(12,'myapp','package_booking'),
(20,'myapp','packagepayment'),
(10,'myapp','place'),
(11,'myapp','user'),
(6,'sessions','session');
...
(26,'myapp','0008_hotelpayment','2024-10-24 07:24:07.504636'),
(27,'myapp','0009_hotel_booking_status','2024-10-24 08:32:28.436611'),
(28,'myapp','0010_package_booking_status','2024-10-24 08:39:38.771623'),
(29,'myapp','0011_packagepayment','2024-10-24 08:43:57.606949'),
(30,'myapp','0012_guide_price','2024-10-24 09:39:56.148453'),
(31,'myapp','0013_guide_booking_total','2024-10-24 09:43:21.860222'),
(32,'myapp','0014_guidepayment','2024-10-24 09:46:30.716511');
...
('a05nevh34jl92f8iq7839noe6rphwk04','.eJyrVsrJTFGyMtFRKi1OLQIxlUyVdJTyUsuhLIiYEZBVkFgZn5ibX5pXAhIwMDBVqgUAJjoRUQ:1t3uie:G6xDEcp4u4MKNWWKl6DaUIfYTtFozCqCzLeYehjE8zE','2024-11-07 10:05:28.886565'),
...
insert  into `myapp_guide`(`id`,`name`,`place`,`email`,`phone`,`post`,`LOGIN_id`,`price`) values 
(2,'Sankar Das N','sedrftg','sankardasnasd@gmail.com','9961207239','dfgh',4,'1'),
(3,'akshay babu','sedrftg','akshay@gmail.com','9961207244','dfgh',5,'1'),
(5,'guide','kasarkod','guide@gmail.com','8961207239','pyyanakal',7,'2000');
...
insert  into `myapp_guide_booking`(`id`,`date`,`GUIDE_id`,`PACKAGE_id`,`USER_id`,`status`,`total`) values 
(2,'2024-10-22',2,4,1,'paid','2005'),
(3,'2024-10-24',5,4,1,'booked','2000');

/*Table structure for table `myapp_guidepayment` */

DROP TABLE IF EXISTS `myapp_guidepayment`;

CREATE TABLE `myapp_guidepayment` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `time` varchar(100) NOT NULL,
  `date` varchar(100) NOT NULL,
  `status` varchar(100) NOT NULL,
  `Guidebooking_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `myapp_guidepayment_Guidebooking_id_cf06ccb0_fk_myapp_gui` (`Guidebooking_id`),
  CONSTRAINT `myapp_guidepayment_Guidebooking_id_cf06ccb0_fk_myapp_gui` FOREIGN KEY (`Guidebooking_id`) REFERENCES `myapp_guide_booking` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `myapp_guidepayment` */

insert  into `myapp_guidepayment`(`id`,`time`,`date`,`status`,`Guidebooking_id`) values 
(1,'15:33:51.091666','2024-10-24','paid',2);
...
insert  into `myapp_hotel_booking`(`id`,`date`,`price`,`number_rooms`,`HOTEL_id`,`USER_id`,`status`) values 
(3,'2024-10-21',3000,'8.0',3,1,'paid'),
(4,'2024-10-22',3000,'8.0',3,1,'paid');

/*Table structure for table `myapp_hotelpayment` */

DROP TABLE IF EXISTS `myapp_hotelpayment`;

CREATE TABLE `myapp_hotelpayment` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `time` varchar(100) NOT NULL,
  `date` varchar(100) NOT NULL,
  `status` varchar(100) NOT NULL,
  `HOTER_BOOKING_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `myapp_hotelpayment_HOTER_BOOKING_id_bffc31ea_fk_myapp_hot` (`HOTER_BOOKING_id`),
  CONSTRAINT `myapp_hotelpayment_HOTER_BOOKING_id_bffc31ea_fk_myapp_hot` FOREIGN KEY (`HOTER_BOOKING_id`) REFERENCES `myapp_hotel_booking` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `myapp_hotelpayment` */

insert  into `myapp_hotelpayment`(`id`,`time`,`date`,`status`,`HOTER_BOOKING_id`) values 
(1,'14:01:44.905980','2024-10-24','paid',4),
(2,'14:04:32.491420','2024-10-24','paid',4),
(3,'15:29:30.836723','2024-10-24','paid',3);
...
(7,'guide@gmail.com','8961207239','guide');
...
(7,'humbi','/media/2024-10-24-14-07-42.jpg','2000.0','wq','5',5);
...
insert  into `myapp_package_booking`(`id`,`date`,`price`,`PACKAGE_id`,`USER_id`,`status`) values 
(5,'2024-10-21',2000,4,1,'paid'),
(6,'2024-10-22',2000,4,1,'paid');

/*Table structure for table `myapp_packagepayment` */

DROP TABLE IF EXISTS `myapp_packagepayment`;

CREATE TABLE `myapp_packagepayment` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `time` varchar(100) NOT NULL,
  `date` varchar(100) NOT NULL,
  `status` varchar(100) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `myapp_packagepayment_PACKAGE_BOOKING_id_9e8115e6_fk_myapp_pac` (`PACKAGE_BOOKING_id`),
  CONSTRAINT `myapp_packagepayment_PACKAGE_BOOKING_id_9e8115e6_fk_myapp_pac` FOREIGN KEY (`PACKAGE_BOOKING_id`) REFERENCES `myapp_package_booking` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `myapp_packagepayment` */

insert  into `myapp_packagepayment`(`id`,`time`,`date`,`status`,`PACKAGE_BOOKING_id`) values 
(1,'14:19:04.021018','2024-10-24','paid',6),
(2,'14:22:04.186042','2024-10-24','paid',6),
(3,'15:30:18.912758','2024-10-24','paid',5);
